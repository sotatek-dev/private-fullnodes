...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .option('-d, --daemon', 'Make dashcore-node a daemon (running in the background)')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `dashcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ dashcore-node add wallet-service');
      console.log('    $ dashcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ dashcore-node remove wallet-service');
      console.log('    $ dashcore-node remove insight-api');
      console.log();
    });
